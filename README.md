...
Скрипт не привязан к конкретному устройству и работает с любыми контроллерами, пэдами и другими устройствами,
передающими MIDI-сообщения.
...
5. Для перехода в обычный режим работы контроллера вернуть тип контроллера на `(generic controller)`.
